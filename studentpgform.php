...
<body>
    ...
    ?>
                ...
                <div class="container text-center">
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-dark" href="./studentmainpg.php">Post</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-dark" href="./studentpgform.php">Forms</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-dark navbar-nav" type="button" href="./pgprofile.php"><i class="bi bi-person-circle"></i><b class="mx-2"><?php echo $row["name"]; ?></b></a>
                            </li>
                            <li class="nav-item">
        ...
        <!-- form -->
        <section id="stform">
            <h1 class="text-center display-2 p-2 fw-bold">Student Details</h1>
            <div class="container p-2 w-100 mb-5 rounded-4 shadow">
                <form method="post" action="pgform.php" enctype="multipart/form-data" class="p-5">
                    <div class="row">
                        <div class="col-12">
                            <center>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="form-floating mb-3">
                                <input type="date" class="form-control" name="dob" id="dobInput" placeholder="Date of Birth" required>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="form-floating">
                                <select class="form-select form-select mb-3" aria-label="Large select example" id="options" name="course" onchange="selectOption()" required>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="form-floating">
                                <select class="form-select form-select mb-3" aria-label="Large select example" name="dept" id="dynamicOptions" required>
                                    <option value="anotherSubOption0">Select Department *</option>
                                    <option value="M.B.A. Business Administration">M.B.A. Business Administration</option>
                                    ...
                                    <option value="M.S.W. Social Work">M.S.W. Social Work</option>
                                    <option value="M.C.A. Computer Applications">M.C.A. Computer Applications</option>
                                    <option value="M.Sc. Zoology">M.Sc. Zoology</option>
                                    <option value="M.Sc. Physics">M.Sc. Physics</option>
                                    <option value="M.Sc. Mathematics">M.Sc. Mathematics</option>
                                    <option value="M.Sc. Library & Information Science">M.Sc. Library & Information Science
                                    </option>
                                    <option value="M.Sc. Information Technology">M.Sc. Information Technology</option>
                                    <option value="anotherSubOption12">M.Sc. Food Science and Nutrition</option>
                                    <option value="M.Sc. Environmental Sciences">M.Sc. Environmental Sciences</option>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="college" id="floatingInput" placeholder="college Studied" required>
                                <label for="floatingInput">College Studied *</label>
                            </div>
                        </div>
                        <div class="col-lg-6 col-12">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="ug" id="floatingInput" placeholder="UG Percentage" required>
                                <label for="floatingInput">UG Percentage *</label>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="pg" id="floatingInput" placeholder="PG Percentage" required>
                                <label for="floatingInput">PG Percentage * (Enter the Percentage Till Concluded Semester)</label>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="input-group mb-3">
                                <input type="file" class="form-control" id="inputGroupFile02" name="user_file1">
                                <label class="input-group-text" for="inputGroupFile02">10th Certificate</label>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="input-group mb-3">
                                <input type="file" class="form-control" id="inputGroupFile02" name="user_file2">
                                <label class="input-group-text" for="inputGroupFile02">12th Certificate</label>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="input-group mb-3">
                                <input type="file" class="form-control" id="inputGroupFile02" name="user_file3">
                                <label class="input-group-text" for="inputGroupFile02">UG Marksheet</label>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="input-group mb-3">
                                <input type="file" class="form-control" id="inputGroupFile02" name="user_file4">
                                <label class="input-group-text" for="inputGroupFile02">PG Marksheet</label>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="input-group mb-3">
                                <input type="file" class="form-control" id="inputGroupFile02" name="user_file5">
