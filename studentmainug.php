...
<body>
    ...
    ?>
        ...
        <div class="offcanvas offcanvas-start w-100" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="offcanvasScrolling" aria-labelledby="offcanvasScrollingLabel">
            ...
            ?>
            <a class="btn btn-secondary w-100" href="./ugprofile.php" role="button">View Full Details</a>
            </div>
        </div>
        ...
        <?php
        // Retrieve job post data along with the respective user profiles
        $PostQuery = "SELECT sp.*, sf.*, sp.stream AS stream FROM staffpost sp INNER JOIN staffform sf ON sp.idnum = sf.idnum WHERE sp.stream = 'For UG' OR sp.stream = 'Both UG and PG'";
            ...
            <div class="d-flex flex-wrap gap-2 mb-4 justify-content-center" id="data-container">
                ...
                ?>
                        <div class="card mb-3 p-2 text-center" style="width: 350px; height:475px;">
                            ...
                            <div class="card-body">
                                <img src="<?php echo $row["photo_path"]; ?>" class="card-img-top img-fluid " style="height:200px; object-fit:contain; object-position:center;" id="cardpreview" alt="">
