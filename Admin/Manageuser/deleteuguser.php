...
if (isset($_POST['delete_user']) && isset($_POST['rollno'])) {
    ...
    $deleteQuery = "DELETE studentlogin, studentugform FROM studentlogin INNER JOIN studentugform ON studentlogin.rollno = studentugform.rollno WHERE studentlogin.rollno = '$rollno'; ";

    // Execute the delete query
    if (mysqli_query($conn, $deleteQuery)) {
        // Deletion successful
        header("Location: ../ugstudenttable.php"); // Redirect to the dashboard or another appropriate page
