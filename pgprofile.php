...
$sql = "SELECT * FROM studentpgform where rollno='$rollno'";
                        ...
                        <div class="card-body p-4 p-md-5">
                            <div class="row bg-body-tertiary">
                                <div class="col-lg-4 col-md-4 col-12 bg-body-secondary rounded-2 text-center p-5">
                                    ...
                                    <center>
                                        <div class="m-5">
                                            <img src="<?php echo $row["photo_path"]; ?>" class="img-fluid" style="width: 200px; height: 250px; object-fit: cover;" alt="..." data-bs-toggle="modal" data-bs-target="#Profile1">
                                        </div>
                                        <!-- Modal -->
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="post" action="updatepgphoto.php" class="p-5" enctype="multipart/form-data">
                                                            ...
                                                            <div class="input-group rounded-circle mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="modal fade" id="viewfiles" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-scrollable modal-xl">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5" id="exampleModalLabel">Uploaded Files</h1>
                                            </div>
                                            <div class="modal-body">
                                                <table class="table table-hover table-borderless h-100">
                                                    <thead>
