...
if ($_FILES['user_file5']['error'] === UPLOAD_ERR_OK) {
    ...
    if (in_array($fileExtension, $allowedExtensions) && $fileSize <= $maxFileSize) {
        ...
        if (move_uploaded_file($fileTmpPath, $uploadPath)) {
            ...
            $sql = "UPDATE studentpgform SET phone='$phone', email='$email', fname='$fname', mname='$mname', peradd='$peradd', city = '$city', pincode = '$pincode', state = '$state', country = '$country',  school1='$school1', school2='$school2', college='$college', tenth='$tenth', twelveth='$twelveth', ug='$ug', pg='$pg', file_path1 =' $pdfUploadPath1', file_path2 = '$pdfUploadPath2', file_path3 = '$pdfUploadPath3', file_path4 = '$pdfUploadPath4', file_path5 = '$pdfUploadPath5' WHERE rollno = $rollno"; // Update this query according to your table structure and fields
